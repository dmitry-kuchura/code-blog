...
@section('content')
    <div class="contact-hero-banner">
        <div class="contact-banner-text">
            ...
            <p>
                Если Вы хотите узнать больше обо мне, моём опыте и моих проектах, <br> или же хотите обсудить реализацию
                Вашего приложения или нанять меня на работу, пожалуйста, заполните форму и отправьте мне сообщение.
            </p>
        </div>
    </div>
